...
```bash
/usr/src/tensorrt/bin/trtexec --onnx=models/yolo11n-obb_with_plugin.onnx --saveEngine=models/yolo11n-obb_with_plugin.engine --fp16 --staticPlugins=/path/to/your/libcustom_plugins.so
```
